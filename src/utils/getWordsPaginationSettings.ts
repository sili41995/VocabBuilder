import {
  IGetWordsPaginationSettings,
  IGetWordsPaginationSettingsProps,
} from '@/types/types';

const getWordsPaginationSettings = ({
  pageNumbers,
  currentPage,
  step,
}: IGetWordsPaginationSettingsProps): IGetWordsPaginationSettings => {
...
export default getWordsPaginationSettings;
